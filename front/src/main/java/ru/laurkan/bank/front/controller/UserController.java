...
import ru.laurkan.bank.front.client.accounts.dto.user.ChangePasswordRequestDTO;
import ru.laurkan.bank.front.client.accounts.dto.user.RegisterUserRequestDTO;
import ru.laurkan.bank.front.client.accounts.dto.user.UpdateUserRequestDTO;
